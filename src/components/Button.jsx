...
export const COLOR_DISABLED = Color(colors.primary)
  .lighten(0.75)
  .rgb()
  .string();

export const COLOR_HOVER = Color(colors.primary)
  .darken(0.25)
  .rgb()
  .string();
...
const ButtonWrapper = styled.div`
  ...
  .pb-container .pb-button {
    ...
    background-color: ${({ disabled }) =>
      disabled ? COLOR_DISABLED : colors.primary};
    ...
    &:hover {
      background-color: ${({ disabled }) =>
        disabled ? COLOR_DISABLED : COLOR_HOVER};
    }
  }
